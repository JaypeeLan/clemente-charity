  ...
  return (
    <footer className={`footer ${isDarkMode ? "dark" : "light"}`}>
      <div className="logo-main">
        <Link href="/">
        <h1 className="logo ">Christamelon Foundation
        </h1>
            <Image
            src="/assets/logo.png"
            width={300}
      ...
      <div className="footer-links mb-4">
        <h4 className="footer-links_heading"> <Link href="/"> Home</Link></h4>
      ...
      <div className="footer-links mb-2">
        ...
        <div className="footer-links">
          ...
          <Link href="https://instagram.com/clemente_charity_foundation?igshid=MzRlODBiNWFlZA==">Instagram</Link>
        </div>
      </div>
